...
<body>
	...
	<h1 style="text-align: center;">
		My Applications &nbsp;<i class="fa-solid fa-circle-check"
	...
	<br>
	<h2>
		Job Applications &nbsp;<i class="fa-solid fa-list"></i>
	</h2>
	<table>
		...
		<tbody>
			<c:forEach items="${myapplicationdetails}" var="e">
				<tr>
					...
					<td data-label="Date">${e.resume}</td>
	...
	<h2>
		Project Applications &nbsp;<i class="fa-solid fa-list"></i>
	</h2>
	<table>
		...
		<tbody>
			<c:forEach items="${projectapplication}" var="ef">
				<tr>
					...
					<td data-label="Product">${ef.cname}</td>
