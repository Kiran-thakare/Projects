						...
						<div class="row">
							<div class="col-md-5 offset-md-1">
								<div class="detail-box">
									<h1>${messageupdatejob}${messageupdateproject}
										${messageupdate }  </h1>
									<h2 style="color: white;">${messageprodelete }
										${messagejobdelete } ${projectPost } ${jobdata}</h2>
									<div class="btn-box">
										<a href="homecompany" class="btn-1"> Home &nbsp; <i
