...
<body>
	<c:forEach items="${companykey }" var="e">
		<form action="updateprofiec" method="post" enctype="multipart/form-data">
					...
					<div class="col-md-3 border-right">
						<div
							...
							<img class="rounded-circle mt-5" width="150px"
								src="./files/webimages/${e.profile }"><span
								class="font-weight-bold">${e.name }</span><span
								class="text-black-50">${e.email }</span><span> </span><br>
							<label>Upload Profile Picture</label><input type="file" name="filename" >
						</div>
					</div>
							...
							<div class="row mt-3">
								...
								<div class="col-md-12">
									<label class="labels">About us</label> <input type="text"
										...
										value="${e.about }" style="height: 100px;">
								</div>
