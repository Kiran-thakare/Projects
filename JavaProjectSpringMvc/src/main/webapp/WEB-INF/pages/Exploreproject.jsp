						...
						<div class="row">
							<div class="col-md-5 offset-md-1">
								<div class="detail-box">
									<h1>
										Explore Your <br> Suitable Projects<br> According to
										your skills

									</h1>
									<h2 style="color: red;">${messagejobsuccess}</h2>
									<h2 style="color: red;">${messageproject}</h2>
									<div class="btn-box">
										<a href="homefreelancer" class="btn-1"> Home &nbsp; <i
				...
				<div class="col-md-3 col-lg-4">
					<div class="card mb-4 project" data-groups="[&quot;skill1&quot;]">
						...
						<div class="card-body">
							...
							<center>
								<a href="viewapplyproject/${e.id}"><button type="button"
										class="btn btn-primary">
										View and Apply <i class="fa-solid fa-angles-right"></i>
									</button></a>
							</center>

							<a href="./files/webimages/${e.projectpdf}"
								class="download-button" download="ProjectPlus Documentation.PDF">
								Download Documentation PDF &nbsp; <i
...
.boxed-portfolio .card {
	background-color: #fff;
	-webkit-box-shadow: 0 1px 4px rgba(0, 0, 0, 0.025), 0 1px 4px
		rgba(0, 0, 0, 0.05) !important;
	box-shadow: 0 1px 4px rgba(0, 0, 0, 0.025), 0 1px 4px
		rgba(0, 0, 0, 0.05) !important;
}
